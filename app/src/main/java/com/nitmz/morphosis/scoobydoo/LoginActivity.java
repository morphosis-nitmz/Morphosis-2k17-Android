...
>>>>>>> undo
    ...
    private void showProgress(final boolean show) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            mProgressView.setVisibility(show ? View.VISIBLE : View.GONE);
            signInHide.setVisibility(show ? View.GONE : View.VISIBLE);
            // Default: mLoginFormView.setVisibility(show ? View.GONE : View.VISIBLE);
        }
    }
    ...
    private boolean isEmailValid(String email) {
        //TOD: Replace this with your own logic
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            // TOD: attempt authentication against a network service.
            ...
            // TOD: register the new account here.
            return true;
        }
